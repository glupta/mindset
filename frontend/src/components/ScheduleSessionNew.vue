<template>
    <div class="schedulenewsession anima-word-break ">
            <div style="width: 1440px; height: 100%; position:relative; margin:auto;">
                <div class="webnavbarsignedinalert">
                    <img src="@/assets/img/schedulenewsession-rectangle-copy-4.png" class="rectanglecopy4" />
                    <div class="verticals">
                        <div class="schedule">
                    ...
                    <div class="signedinuseralert">
                        <div class="group3">
                            <img src="@/assets/img/schedulepublicsession-rectangle-4@2x.png" class="rectangle" />
                            <div class="iconschevrondown">
                                <img src="@/assets/img/schedulenewsession-iconschevron-down@2x.png" class="iconschevrondown1" />
                            </div>
                            <div class="signedinalertdot">
                                <img src="@/assets/img/schedulenewsession-oval@2x.png" class="oval" />
                                <img src="@/assets/img/schedulenewsession-oval-1@2x.png" class="oval1" />
                            </div>
                            <div class="username">
                                Leonetta L.
                            </div>
                            <div class="usernamecopy">
                                21:47
                            </div>
                    ...
                    <div class="logologo28x48">
                        <div class="group20">
                            <img src="@/assets/img/schedulenewsession-shape@2x.png" class="shape" />
                            <img src="@/assets/img/schedulenewsession-oval-copy-23@2x.png" class="ovalcopy23" />
                        </div>
                    </div>
                </div>
                <div class="calendar">
                    <div class="calendar1">
                        <div class="daysoftheweekdate">
                            ...
                            <div class="a4">
                                ...
                                <div class="date">
                                    <img src="@/assets/img/schedulepublicsession-date@2x.png" class="date1" />
                                </div>
                            </div>
                            <div class="a3">
                                <div class="base">
                            ...
                            <div class="iconschevronright">
                                <img src="@/assets/img/schedulenewsession-iconschevron-right@2x.png" class="iconschevronright2" />
                            </div>
                            <img src="@/assets/img/schedulenewsessionpopup-iconschevron-right-1@2x.png" class="iconschevronright1" />
                        </div>
                        <div class="jul">
                            JUL
                        </div>
                ...
                <div class="sessionoptions">
                    <div class="sessionoptions1">
                        Select from available times <br />or schedule your own!
                    </div>
                    <div class="schedulenewpublicsolomenu">
                        <div class="group11">
                            <img src="@/assets/img/schedulepublicsession-rectangle@2x.png" class="rectangle" />
                            <div class="publicsession" @click="onPublicSelect()">
                                <div class="rectangle1">
                                </div>
                                ...
                                <div class="group5">
                                    ...
                                    <div class="iconschevronrightcopy">
                                        <img src="@/assets/img/schedulenewsession-iconschevron-right-2@2x.png" class="iconschevronrightcopy1" />
                                    </div>
                                </div>
                            </div>
                            <div class="newsession1">
                                <img src="@/assets/img/schedulenewsessionpopup-rectangle-2@2x.png" class="rectangle1" />
                                ...
                                <div class="group8">
                                    ...
                                    <div class="iconschevronright">
                                        <img src="@/assets/img/schedulenewsession-iconschevron-right-2@2x.png" class="iconschevronright1" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="newsession">
                    <img src="@/assets/img/schedulenewsession-rectangle-3.png" class="rectangle" />
                    ...
                    <div class="newsessionstarttime">
                                ...
                                <div class="hour">
                                    <div class="group4">
                                        ...
                                        <select v-model="hour_selected">
                                            <option disabled value="" class="a12">hr</option>
                                            <option v-for='hour in hours' class="a12">{{hour}}</option>
                                        </select>
                                        </div>
                                        <div class="iconschevrondown">
                                            <img src="@/assets/img/schedulepublicsession-iconschevron-down@2x.png" class="iconschevrondown1" />
                                        </div>
                                    </div>
                                    <div class="a12">
                                        12
                                ...
                                <div class="minutes">
                                    <div class="group2">
                                        ...
                                        <div class="iconschevrondowncopy">
                                            <img src="@/assets/img/schedulepublicsession-iconschevron-down@2x.png" class="iconschevrondowncopy1" />
                                        </div>
                                    </div>
                                    <div class="a00">
                                        30
                        ...
                        <div class="toggleonoff">
                            <div class="group6">
                                <div class="group5">
                                    <img src="@/assets/img/schedulenewsession-rectangle-4@2x.png" class="rectangle1" />
                                    <div class="group4">
                                        <div class="am">
                                            AM
                                        </div>
                    ...
                    <div class="newsessioninvfriends">
                        ...
                        <div class="entrysignin">
                            ...
                            <div class="createpassword"-->
                                <input v-model='user_email' placeholder="Email or Phone Number" class="rectanglecopy createpassword">
                            <!--/div-->
                        </div>
                    </div>
                    <div class="scheduleprivate">
                        <div class="group2">
                            ...
                            <div class="iconsinfo">
                                <img src="@/assets/img/schedulenewsession-iconsinfo@2x.png" class="iconsinfo1" />
                            </div>
                        </div>
                    </div>
                    <div class="buttondarkcopy">
                        <img src="@/assets/img/schedulenewsession-rectangle-5@2x.png" class="rectangle1" />
                        <div class="confirm">
                            CONFIRM
                        </div>
                        <div class="circlearrow">
                            <img src="@/assets/img/schedulepublicsession-oval@2x.png" class="oval" />
                            <div class="chevronright">
                                <img src="@/assets/img/schedulenewsessionpopup-chevron-right@2x.png" class="chevronright1" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="footer">
                    <img src="@/assets/img/schedulenewsessionpopup-rectangle-copy-5.png" class="rectanglecopy5" />
                    <div class="footercontent">
                        <div class="footerleft">
                            <div class="aboutus">
                                ...
                                <div class="aboutheadspace">
                                    About Headspace
                                </div>
                                <div class="pressmedia">
                                    Press &amp; Media
                                </div>
                                <div class="careers">
                                    Careers
                            ...
                            <div class="partnerships">
                                <div class="partnershipscopy">
                                    PARTNERSHIPS
                                </div>
                                <div class="researchpartners">
                                    Research Partners
                                </div>
                            ...
                            <div class="logologo94x160">
                                <div class="background">
                                </div>
                                <div class="group20">
                                    <img src="@/assets/img/schedulepublicsession-shape-1@2x.png" class="shape" />
                                    <img src="@/assets/img/schedulepublicsession-oval-copy-23-1@2x.png" class="ovalcopy23" />
                                </div>
                            </div>
                            <div class="getsomeheadspace">
                                <div class="getsomeheadspacecopy2">
                                    GET SOME HEADSPACE
                                </div>
                                <div class="subscribe">
                                    Subscribe
                            ...
                            <div class="ourcommunity">
                                <div class="ourcommunitycopy">
                                    OUR COMMUNITY
                                </div>
                                <div class="blog">
                                    Blog
                                </div>
                                <div class="joinourfbgroups">
                                    Join our FB Groups
                                </div>
                            </div>
                            <div class="support">
                        ...
                        <div class="footerright">
                            <div class="termsconditionscopy2">
                                TERMS &amp; CONDITIONS
                            </div>
                            <div class="privacypolicycopy2">
                                PRIVACY POLICY
                            </div>
                            <div class="cookiepolicycopy2">
                                COOKIE POLICY
                            </div>
                            <div class="sitemapcopy2">
                                SITE MAP
                            </div>
                            <div class="a2512020headspaceinccopy2">
                                © 2020 HEADSPACE INC.
                            </div>
                        </div>
                        <div class="footersocialicons">
                            <div class="socialigcopy">
                                <div class="ig">
                                    <div class="rectangle">
                                    </div>
                                    <div class="rectangle1">
                                        <img src="@/assets/img/schedulepublicsession-rectangle-5@2x.png" class="rectangle2" />
                                    </div>
                                </div>
                            </div>
                            <div class="socialyoutubecopy">
                                <div class="youtube">
                                    <div class="rectanglecopy51">
                                    </div>
                                    <div class="rectangle">
                                        <img src="@/assets/img/schedulenewsession-rectangle-7@2x.png" class="rectangle1" />
                                    </div>
                                </div>
                            </div>
                            <div class="sociallinkedincopy">
                                <div class="linkedin">
                                    <div class="rectanglecopy4">
                                    </div>
                                    <div class="rectangle">
                                        <img src="@/assets/img/schedulenewsession-rectangle-8@2x.png" class="rectangle1" />
                                    </div>
                                </div>
                            </div>
                            <div class="socialfacebookcopy">
                                <div class="facebook">
                                    <div class="rectanglecopy9">
                                    </div>
                                    <div class="rectangle">
                                        <img src="@/assets/img/schedulenewsession-rectangle-9@2x.png" class="rectangle1" />
                                    </div>
                                </div>
                            </div>
                            <div class="socialtwittercopy">
                                <div class="twitter">
                                    <div class="rectanglecopy10">
                                    </div>
                                    <div class="rectangle">
                                        <img src="@/assets/img/schedulepublicsession-rectangle-9@2x.png" class="rectangle1" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
  ...
  mounted() {
    ...
    .then(response => {
      ...
      response.json().then(data => {
        ...
        for (let i = 0; i < 7; i++) { //create next 6 days in week
          ...
          console.log("today:",today,"format:",today_format,"day:",this.week_day[i]);
          today.setDate(today.getDate() + 1);
        }

        console.log("current:",this.time_current,"today:",today);
        console.log("week:",this.week,"weekdates:",this.week_dates,"weekday:",this.week_day);
  ...
  methods: {
    ...
    onPublicSelect() {
        router.push({ name: "ScheduleSession2" });  
    },
  }
}
</script>
